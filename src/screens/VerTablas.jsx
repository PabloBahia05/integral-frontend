...
const MODULOS = [
  ...
  { id: "confirmados",               label: "Confirmados",            acciones: ["ver"] },
  { id: "obras",                     label: "Obras",                  acciones: ["ver", "editar"] },
  ...
  { id: "sketchup",                  label: "SketchUp",               acciones: ["ver", "crear", "eliminar"] },
...
const PANTALLAS_MENU = [
  ...
  { id: "confirmados", label: "Confirmados", icon: "🔒", ubicacionDefault: "principal" },
  { id: "obras", label: "Obras", icon: "🏗️", ubicacionDefault: "principal" },
