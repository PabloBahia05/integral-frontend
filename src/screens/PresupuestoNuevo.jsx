...
export default function PresupuestoNuevo({
  ...
  const [cocinaFila, setCocinaFila] = useState({
    articulo: "",
    nombreart: "",
    cantidad: 1,
    precio: "",
  ...
  const productosFiltrados = articulosFamilia
    .filter(
      (a) =>
        !searchActual.trim() ||
        normalizar(a.articulo).includes(normalizar(searchActual)),
    )
    .slice(0, 10);
    ...
    <>
      ...
      <div className="pn-root">
        ...
        <div className="pn-body">
                    ...
                    <div style={{ flex: "0 0 auto", paddingTop: 20 }}>
                      <button
                        ...
                        style={{
                          ...
                          fontFamily: "'Space Mono',monospace",
                          fontSize: 12,
                          cursor: cocinaFila.articulo.trim()
                            ? "pointer"
                            : "default",
                          transition: "background 0.12s",
                        }}
            ...
            >
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => {
                    if (key === "vanitory") {
                      setEspecialesVista(key);
                      setVanitoryVista("tipos");
                    } else if (key === "despensero") {
                      setEspecialesTipo(key);
                      setDespenseroVista("tipos");
                      setDespenseroModelo(null);
                      setEspecialesVista(key);
                    } else {
                      // Para escritorio y wallpanel, inicializar medidas y navegar directo
                      setEspecialesTipo(key);
                      setEspecialesMedidas(MEDIDAS_INIT);
                      setMaterialSearch("");
                      setGuiasSearch("");
          ...
          {/* ── PANTALLA MEDIDAS (Vanitory) ── */}
          {tab === "especiales" &&
            especialesVista === "vanitory" &&
            vanitoryVista === "medidas" && (
              <EspecialesMedidasForm
                tipo="vanitory"
                icono="🚿"
                titulo={
                  vanitoryModelo ? `Vanitory — ${vanitoryModelo}` : "Vanitory"
                }
                medidas={especialesMedidas}
                setMedidas={setEspecialesMedidas}
              ...
              <PresupuestoVanitory
                ...
                onGuardado={(data) => {
                  ...
                  const presv =
                    data.presv ??
                    (vtablaId != null
                      ? `V${String(vtablaId).padStart(5, "0")}`
                      : null);
                  agregarAPresupuesto({
          ...
          {/* ── WALL PANEL ── */}
          {tab === "especiales" && especialesVista === "wallpanel" && (
            <PresupuestoWallPanel
              onVolver={() => setEspecialesVista("selector")}
            />
          )}

          {/* ── PANTALLA MEDIDAS (Escritorio) ── */}
          {tab === "especiales" && especialesVista === "escritorio" && (
            <EspecialesMedidasForm
              ...
              onVolver={() => setEspecialesVista("selector")}
              onContinuar={() => {
                // TODO: navegar a la pantalla de armado de escritorio cuando esté disponible
                alert(
                  `Escritorio cargado:\nAncho: ${especialesMedidas.ancho}cm | Alto: ${especialesMedidas.alto}cm | Prof: ${especialesMedidas.profundidad}cm\nPlaca: ${especialesMedidas.materialPlaca} | Guías: ${especialesMedidas.guias}`,
                );
              }}
            />
          )}
          ...
          {/* ── TIPOS DESPENSERO ── */}
          {tab === "especiales" &&
            especialesVista === "despensero" &&
            despenseroVista === "tipos" &&
            (tiposDespensero.length === 0 ? (
              <div
                style={{
                  fontFamily: "'Space Mono',monospace",
                  padding: "40px 0",
              ...
              >
                ...
                >
                  Primero cargá los modelos desde la tabla de administración y
                  luego volvé para armar el presupuesto.
                </div>
          ...
          {/* ── PANTALLA PRESUPUESTO DESPENSERO ── */}
          {tab === "especiales" &&
            especialesVista === "despensero" &&
            despenseroVista === "presupuesto" && (
