...
const applyRender = (col) => {
  if (
    ["PRECIO", "COLOCACION", "MATERIAL_PRECIO", "CORREDERA_PRECIO"].includes(
      col.key,
    )
  )
  ...
  const openHistorial = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API}/presupuestos-vanitory/${numeroParam}/revisiones`,
      );
