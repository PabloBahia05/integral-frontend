...
export default function AsocFormStd({
  asocFormStd = [],
  productos = [],
  selected,
  modal,
      ...
      <div className="aform-root">
        <div className="aform-header">
          <div className="aform-header-left">
            <span className="aform-eyebrow">Gestión de fórmulas estándar</span>
            <div className="aform-title">
              <div className="aform-title-icon">🧮</div>
              Asociación Fórmulas Estándar
            </div>
          </div>
        </div>
                    ...
                    <td colSpan={4 + SLOTS.length + 1}>
                      <div className="aform-empty">
                        ...
                        <div className="aform-empty-text">
                          Sin registros de fórmulas estándar asociadas
                        </div>
                      </div>
                    </td>
                  </tr>
                        ...
                        <div className="aform-actions">
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              if (
                                window.confirm(
                                  "¿Eliminar esta asociación de fórmula estándar?",
                                )
                              )
                                onDelete?.(row);
                            }}
            ...
            >
              <div className="aform-modal-header" onMouseDown={onDragStart}>
                <div className="aform-modal-title">
                  🧮{" "}
                  {editId !== null
                    ? "Editar Asociación de Fórmula Estándar"
                    : "Nueva Asociación de Fórmula Estándar"}
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 400,
